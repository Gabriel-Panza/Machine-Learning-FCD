...
def divide_16_pieces(rotated_slice):
    ...
    left_half = rotated_slice[:, 6:midpoint]
    right_half = rotated_slice[:, midpoint:midpoint*2 - 6]
    ...
    top_left_top_left, top_left_top_right, top_left_bottom_left, top_left_bottom_right = split_quadrant(top_left)
    top_right_top_left, top_right_top_right, top_right_bottom_left, top_right_bottom_right = split_quadrant(top_right)
    bottom_left_top_left, bottom_left_top_right, bottom_left_bottom_left, bottom_left_bottom_right = split_quadrant(bottom_left)
    bottom_right_top_left, bottom_right_top_right, bottom_right_bottom_left, bottom_right_bottom_right = split_quadrant(bottom_right)

    return (top_left_top_left, top_left_top_right, top_left_bottom_left, top_left_bottom_right, 
            bottom_left_top_left, bottom_left_top_right, bottom_left_bottom_left, bottom_left_bottom_right, 
            top_right_top_left, top_right_top_right, top_right_bottom_left, top_right_bottom_right, 
            bottom_right_top_left, bottom_right_top_right, bottom_right_bottom_left, bottom_right_bottom_right)
...
for img, mask in zip([f for f in os.listdir(imagens) if f.endswith(('.nii', '.nii.gz'))], [f for f in os.listdir(mascara) if f.endswith(('.nrrd', '.nii', '.nii.gz'))]):    
    ...
    for slice_idx in range(lesion_data.shape[2]):
        ...
        subimages_lesion = [
            ...
            (right_top_top_left, f"right_1_lesion_{calculate_label(right_top_top_left)}"),
            (left_top_top_right, f"left_2_lesion_{calculate_label(left_top_top_right)}"),
            (right_top_top_right, f"right_2_lesion_{calculate_label(right_top_top_right)}"),
            (left_top_bottom_left, f"left_3_lesion_{calculate_label(left_top_bottom_left)}"),
            (right_top_bottom_left, f"right_3_lesion_{calculate_label(right_top_bottom_left)}"),
            (left_top_bottom_right, f"left_4_lesion_{calculate_label(left_top_bottom_right)}"),
            (right_top_bottom_right, f"right_4_lesion_{calculate_label(right_top_bottom_right)}"),
            (left_bottom_top_left, f"left_5_lesion_{calculate_label(left_bottom_top_left)}"),
            (right_bottom_top_left, f"right_5_lesion_{calculate_label(right_bottom_top_left)}"),
            (left_bottom_top_right, f"left_6_lesion_{calculate_label(left_bottom_top_right)}"),
            (right_bottom_top_right, f"right_6_lesion_{calculate_label(right_bottom_top_right)}"),
            (left_bottom_bottom_left, f"left_7_lesion_{calculate_label(left_bottom_bottom_left)}"),
            (right_bottom_bottom_left, f"right_7_lesion_{calculate_label(right_bottom_bottom_left)}"),
            (left_bottom_bottom_right, f"left_8_lesion_{calculate_label(left_bottom_bottom_right)}"),
            (right_bottom_bottom_right, f"right_8_lesion_{calculate_label(right_bottom_bottom_right)}")
        ]
